...
type PopUpMenuTypes = {
  expense: MonthlyExpenseTypes
  onClose: () => void
}

export default function PopUpMenuThreeMonths({ expense, onClose }: PopUpMenuTypes) {
    ...
    <div className='fixed inset-0 bg-black/40 flex items-end justify-center z-50'>
      ...
      <div className='w-full h-[50vh] bg-white rounded-t-2xl p-6'>
        ...
        <div className='mt-6 space-y-4'>
          <p>
            <span className='font-semibold'>Three Months Expense:</span>{' '}
