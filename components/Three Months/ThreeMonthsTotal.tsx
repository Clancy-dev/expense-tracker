...
export default function ThreeMonthsTotal({totalThreeMonthsExpenses,coveredThreeMonthsAmount,threeMonthsBalance}:any) {
    ...
    <div className='w-full h-full flex flex-col gap-1 p-2.5 border-t-2 border-gray-300'>
        ...
        <div className='w-full h-full flex  items-center justify-center  rounded'>
            ...
            <div className='w-[40%] h-full flex items-center justify-start font-bold p-1'>
                UGX {totalThreeMonthsExpenses.toLocaleString()}
        ...
        <div className='w-full h-[32% px-2 md:px-4'>
            ...
            <div className='w-[40%] h-full  flex items-center justify-start font-bold p-1'>
                <span className='text-black'>UGX {coveredThreeMonthsAmount.toLocaleString()}</span>
        ...
        <div className='w-full h-[32%] px-2 md:px-4'>
            ...
            <div className='w-[40%] h-full  flex items-center justify-start font-bold sm:p-1'>
                <span className={threeMonthsBalance === 0 ? 'text-black' : 'text-green-600'}>UGX {threeMonthsBalance.toLocaleString()}</span>
